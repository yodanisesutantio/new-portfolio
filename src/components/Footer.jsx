...
const Footer = () => {
  ...
  return (
    <div className="flex justify-between items-center p-2">
        <p className="text-sm font-normal font-nunito text-[#fffbfc]/40">© {currentYear} Portfolio by Yodanis E. Sutantio</p>
        ...
        <ul className="flex space-x-12">
            ...
            <li>
                <Link to="/resume" className="flex flex-col font-nunito font-normal text-[#fffbfc]/40 text-sm hover:text-[#fffbfc] duration-500 group">Resume</Link>
            </li>
        </ul>
    </div>
  )
